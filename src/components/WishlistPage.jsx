...
const WishlistPage = ({ wishlist, onAddToCart, onRemove, onViewProduct, onContinueShopping }) => {
    if (wishlist.length === 0) {
        return (
            <div className="empty-cart-container fade-in" style={{ padding: '100px 20px', textAlign: 'center' }}>
    ...
    return (
        <div className="wishlist-page fade-in" style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
